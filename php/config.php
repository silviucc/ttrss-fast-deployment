<?php
	...
	define('LOCK_DIRECTORY', getenv('OPENSHIFT_DATA_DIR') . "lock");
	define('CACHE_DIR', getenv('OPENSHIFT_DATA_DIR') . 'cache');
	define('TMP_DIRECTORY', getenv('OPENSHIFT_DATA_DIR') . "tmp");
	define('ICONS_DIR', getenv('OPENSHIFT_DATA_DIR') . "icons");
